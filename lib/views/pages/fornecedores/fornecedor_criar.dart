...
class FornecedorCriar extends StatefulWidget {
  const FornecedorCriar({super.key});

  @override
  State<FornecedorCriar> createState() => _FornecedorCriarState();
}

class _FornecedorCriarState extends State<FornecedorCriar> {
